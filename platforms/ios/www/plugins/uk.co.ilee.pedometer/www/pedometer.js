...
Pedometer.prototype.queryPedometerDataFromDate = function (fromDate, toDate, onSuccess, onError) {
    exec(onSuccess, onError, "Pedometer", "queryPedometerDataFromDate", [fromDate, toDate]);
};
